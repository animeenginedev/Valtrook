...
namespace Val {
	...
	public:
		...
		SimpleTextRectangle(const TextResource& texture, float x, float y, float depth, float halfWidth, float halfHeight, Colour colour, GLBlendMode* blendMode = &GLBlendMode::Blend_Default);
		SimpleTextRectangle(const TextResource& texture, std::array<float, 2> center, float depth, std::array<float, 2> halfSize, Colour colour, GLBlendMode* blendMode = &GLBlendMode::Blend_Default);
		~SimpleTextRectangle();
